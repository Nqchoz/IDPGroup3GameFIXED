...
public class SheetsManager : MonoBehaviour
{
    public static void Initialize()
    {
        ...
        { //The string is the filepath from the root directory of the c# project, starting in the same folder as the project's .csproj.
    ...
    public static string ApplicationName = "TitleScreen"; //Can be anything
    public static string SpreadsheetID = "1jOGjA3UDEoJcltcoF3J47_8pGrknyGpYC5xtYkH1yo0"; //Spreadsheet ID, found in the link to the spreadsheet (docs.google.com/spreadsheets/d/ID/edit)
    public static string sheet = "Sheet 2"; //The name of the sheet, in the bottom left (Can also be changed to a method argument or string[] instead of hard-coded if using several sheets)
    ...
    { //rangelow and rangehigh are cells like A1 or F12
    ...
    { //leftColumn and rightColumn are the column letters.
